...
# -----------------------------
class BookingPolicyAction(Action):
    """
    ...
    def name(self) -> str:
        return "action_booking_policy_validation"
    ...
    def run(
        ...
        def reject(reason: str):
            dispatcher.utter_message(
                text=(
                    f"Booking request requires operational review. "
                    f"Reason: {reason}."
                )
            )
            return [
        ...
        dispatcher.utter_message(
            text=(
                "Booking request successfully validated. "
